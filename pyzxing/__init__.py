...
# Original wrapper by Nate Oostendorp
...
class BarCodeReader():
    location = ""
    command = "java"
    libs = ["javase/javase-" + __zxingversion__ + ".jar", "core/core-" + __zxingversion__ + ".jar"]
    ...
    def decode(self, files, try_harder = False, qr_only = False):
        ...
        if qr_only:  # This is a little hacky, if anyone has time feel free to add proper format selection
